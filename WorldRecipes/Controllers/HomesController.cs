...
namespace WorldRecipes.Controllers
{
    public class HomesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,HeroImage,HomeParagraph,RecipesImage,AboutImage,AboutParagraph")] Home home)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,HeroImage,HomeParagraph,RecipesImage,AboutImage,AboutParagraph")] Home home)
        {
            if (id != home.Id)
            {
                return NotFound();
